...
<div id="socials" class="flex space-x-3 h-[50px] mt-3">
  <button
    class="flex items-center bg-pink-500 text-white rounded-full px-2 h-7 group"
    aria-label="Copy Link"
    data-id="copy"
  ...
  <button
    class="flex items-center bg-[#01e676] text-white rounded-full px-1.5 h-7 group overflow-hidden"
  ...
  <button
    class="flex items-center bg-black text-white rounded-full px-2 h-7 group"
